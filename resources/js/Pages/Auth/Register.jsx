...
export default function Register() {
    ...
    const submit = (e) => {
        ...
        post(route('register'), {
            onFinish: () => reset('password', 'password_confirmation', 'invite_code'),
        });
    };
    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-8 text-center">
                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Crie uma conta</h2>
                <p className="text-slate-500 dark:text-slate-400">Junte-se ao SpendSense hoje mesmo</p>
            </div>

            <form onSubmit={submit}>
                <div>
                    <InputLabel htmlFor="invite_code" value="Código de Registo" />
