            ...
            <div className="mx-auto max-w-7xl px-4 py-6 md:px-6 lg:px-8">
                ...
                <div className="mb-8">
                    <h3 className="text-base font-bold text-slate-700 mb-4 flex items-center gap-2">
                        ...
                        Despesas
                        <span className="text-sm font-normal text-slate-400">({expenseCategories.length})</span>
                    </h3>
                    ...
                    {expenseCategories.length > 0 ? (
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            {expenseCategories.map((category) => (
                                <div
                                    key={category.id}
                                    className="group flex items-center justify-between rounded-2xl bg-white p-4 shadow-md shadow-slate-200/50 border border-slate-100 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5"
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-rose-50 text-rose-500 transition-transform duration-200 group-hover:scale-110">
                        ...
                        <div className="rounded-2xl bg-white p-8 text-center shadow-md shadow-slate-200/50 border border-slate-100">
                            <p className="text-sm text-slate-400">Nenhuma categoria de despesas criada.</p>
                        </div>
                    )}
                </div>
                ...
                <div>
                    <h3 className="text-base font-bold text-slate-700 mb-4 flex items-center gap-2">
                        ...
                        Receitas
                        <span className="text-sm font-normal text-slate-400">({incomeCategories.length})</span>
                    </h3>
                    ...
                    {incomeCategories.length > 0 ? (
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            {incomeCategories.map((category) => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-50 text-emerald-500 transition-transform duration-200 group-hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                                            </svg>
                                        </div>
                        ...
                        <div className="rounded-2xl bg-white p-8 text-center shadow-md shadow-slate-200/50 border border-slate-100">
                            <p className="text-sm text-slate-400">Nenhuma categoria de receitas criada.</p>
                        </div>
                    )}
                </div>
            </div>
